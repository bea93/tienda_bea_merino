...
public class Usuario {
	...
	//Constructor para crear a mano los usuarios admin, empleado y cliente
	public Usuario(int id, int idRol, String email, String clave) {
		super();
		this.id = id;
		this.idRol = idRol;
		this.email = email;
	...
	//Constructor para el registro de clientes
